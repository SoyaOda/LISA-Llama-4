...
echo "CUDA_VISIBLE_DEVICES=0 python train_ds.py --deepspeed --deepspeed_config=ds_config.json --version=\"meta-llama/Llama-3.2-11B-Vision-Instruct\" --dataset_dir='./small_test_dataset' --vision_pretrained=\"./checkpoints/sam_vit_h_4b8939.pth\" --vision-tower=\"meta-llama/Llama-3.2-11B-Vision-Instruct\" --dataset=\"sem_seg||refer_seg||vqa||reason_seg\" --sample_rates=\"9,3,3,1\" --exp_name=\"lisa-llama3-2-vision-test\" --conv_type=\"llama_3\" --precision=\"bf16\" --batch_size=1 --grad_accumulation_steps=1 --steps_per_epoch=2 --epochs=1 --no_eval" 